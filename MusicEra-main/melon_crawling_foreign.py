...
for year in range(1990, 2023):  # 1990년부터 2022년까지의 데이터를 가져옵니다.
    # 해당 년도의 멜론차트 URL 생성
    url = f'https://www.melon.com/chart/age/index.htm?chartType=YE&chartGenre=POP&chartDate={year}'
...
full_df.to_csv("src/MelonChart_Full_with_Genres_Foreign.csv", encoding="utf-8-sig", index=False)
